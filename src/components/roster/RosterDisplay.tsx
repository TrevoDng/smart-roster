...
<body>
  <div class="print-container">
    ...
    try {
      ...
      if (newWindow) {
        ...
        newWindow.focus();
        console.log('✅ Roster opened in new tab! Use "Save as" to download.');
      } else {
        console.error('Unable to download. Please allow popups or use a different browser.');
      }
    }
  ...
  const handleDownloadPdf = useCallback(() => {
    ...
    const columnCount = currentData.headers.length + 1;
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    @media print {
      ...
      .print-container { max-width: 100% !important; padding: 10px !important; }
      table { font-size: ${needsWideFormat ? '8px' : '10px'} !important; }
      th { font-size: ${needsWideFormat ? '7px' : '9px'} !important; }
      td { font-size: ${needsWideFormat ? '7px' : '9px'} !important; }
      .staff-name { font-size: ${needsWideFormat ? '7px' : '9px'} !important; min-width: ${needsWideFormat ? '60px' : '80px'} !important; }
      .company-number { font-size: ${needsWideFormat ? '6px' : '8px'} !important; }
      thead { display: table-header-group !important; }
      tr { page-break-inside: avoid !important; }
      @page { size: ANSI-F landscape; margin: 0.2in; }
    }
  </style>
</head>
<body>
